# Open Services Group GitHub Organization Labels
...
based on the [labels.yaml](https://github.com/open-services-group/community/blob/master/labels.yaml) that it uses to
...
- Open a PR, _with a single commit_, that:
  - updates [labels.yaml](https://github.com/open-services-group/community/blob/master/labels.yaml) with the new label(s)
