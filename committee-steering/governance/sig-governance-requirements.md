...
any subarea of the Open Services Group.
...
- *MUST* define how technical assets of project remain healthy and can be released
  ...
  - Commitment and process to ensure assets are in a releasable state for milestones / releases
    coordinated across multiple areas / subprojects
  - *SHOULD* define target metrics for health signal
  - *SHOULD* define process for meeting target metrics
